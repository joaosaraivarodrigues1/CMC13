...
Descreva aqui os procedimentos realizados para preparar os dados:
an\'alise explorat\'oria, tratamento de dados faltantes, remo\c{c}\~ao de colunas
irrelevantes, codifica\c{c}\~ao de vari\'aveis categ\'oricas, normaliza\c{c}\~ao, etc.
...
Descreva o modelo escolhido, hiperpar\^ametros utilizados e resultados obtidos.
...
Descreva o modelo de comit\^e escolhido, hiperpar\^ametros e resultados obtidos.
